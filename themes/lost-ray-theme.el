...
(deftheme lost-ray "A dark color theme for Emacs")

(let ((*background*         "#161A1F")
      (*comments*           "#C2C9C2")
      (*constant*           "#F38630")
      (*current-line*       "#151515")
      (*cursor-underscore*  "#00FF00")
      (*keywords*           "#FFA927")
      (*line-number*        "#061A1F")
      (*method-declaration* "#FFD2A7")
      (*mode-line-bg*       "#CCCCCC")
      (*mode-inactive-bg*   "#222255")
      (*mode-line-fg*       "#333333")
      ...
      (*string*             "#ffaa91")
      (*variable*           "#C6C5FE")
      (*visual-selection-foreground*   "#00AA00")
      (*visual-selection-background*   "#111111"))
  ...
  (custom-theme-set-faces
   ...
   `(region ((t (:foreground, *visual-selection-foreground* :background, *visual-selection-background*))))
   ...
   ;; search
   `(isearch ((t (:background, *regexp* :foreground, *visual-selection-foreground*))))
   `(isearch-fail ((t (:background, *warning*))))
   `(lazy-highlight ((t (:background, *operators* :foreground, *visual-selection-foreground*))))
